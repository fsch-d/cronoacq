...
#define CRONO_SYNC_MIN_LATENCY_DEFAULT 1000000000LL
/*!@}*/

/*! \ingroup conffuncts
* \brief Copies the default configuration to the specified config pointer
*/
CRONO_API int crono_sync_get_default_configuration(crono_sync *sync, crono_sync_configuration *config);
